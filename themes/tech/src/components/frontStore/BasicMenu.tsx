              ...
              {menus.map((item, index) => (
                <li key={index} className="relative group">
                  ...
                  {item.children.length > 0 && (
                    <ul className="md:absolute left-0 top-full mt-0 md:mt-2 w-30 bg-white md:shadow-lg rounded-md md:h-0 md:group-hover:h-100 md:group-hover:translate-y-0 transform transition-all duration-300 ease-in-out min-w-full md:min-w-[250px] z-30 md:border-t-4">
